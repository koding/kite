...
func (r *RemoteKite) SetCallTimeout(d time.Duration) { r.callTimeout = d }
...
func (r *RemoteKite) CallWithTimeout(method string, args interface{}, timeout time.Duration) (result *dnode.Partial, err error) {
